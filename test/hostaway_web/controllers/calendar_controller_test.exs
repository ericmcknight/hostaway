defmodule HostawayWeb.CalendarControllerTest do
    ...
    test "Testing back to back booking" do
        {_status, startDate} = CalendarService.parse_date_text("2020-08-15")
        {_status, endDate} = CalendarService.parse_date_text("2020-08-23")
        ...
        Logger.debug(Poison.encode!(value))
